...
function getOptions() {
  ...
  // Set player and computer based on selected options
  ...
  // Check if "Play With Friend" checkbox is checked
  if (document.getElementById("playWithFriend").checked) {
    window.location.href = "index11.html"; // Redirect to new page
    return; // Stop further execution
  }

  // Hide the options modal and proceed with the game
